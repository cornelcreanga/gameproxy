...
public class FastDataInputStream{
    ...
    /**
     * Read a byte array. first 4 bytes are  the array length (or zero for null arrays)
     * @return
     * @throws IOException
     */
...
//            throw new EOFException();
//        return (((long)ch1 << 56) + ((long)ch2 << 48) + ((long)ch3 << 40) + ((long)ch4 << 32)+((long)ch5 << 24) + ((long)ch6 << 16) + ((long)ch7 << 8) + ch8);
//    }
